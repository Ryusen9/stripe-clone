...
export default function GlobalBackbone() {
  return (
    <Box className="w-full bg-[#3D34A4] lg:bg-linear-to-b lg:from-[#3D34A4] lg:to-white from-70% duration-200">
      <Box className="max-w-317.5 mx-auto border-r border-l border-gray-400 lg:pt-20 pt-10 flex flex-col gap-10 lg:gap-20">
        <p className="font-grotesk text-center text-white text-3xl lg:text-6xl font-medium">
